...
<html lang="en">
    <head>
        ...
        <title>Welcome to the Foundation Bank</title>
    ...
    <body style="background-color:#0B172A;">
        ...
        <div id="container">
            ...
            <div class="container-large"
                style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#0B172A;">
                <div class="row">
                    <div class="col" style="margin-left: 5%;">
                        <br><br>&nbsp;<p class="zoomfont"
                            style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to the
                                 Foundation Bank!</b></p>
                    </div>
            ...
            <img src="statics/abstbg2.png" alt="" style="width:100%;height:70%; position:absolute; z-index:-1">
            ...
            <center style="margin:60px 0px 20px 0px;">
                <div class="container"
                    ...
                    <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>What__we__Serve</b></h1>
                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div
                                    ...
                                    <h6>Click for viewing every customer of the bank.</h6>
                                </div>
                            </div>
                            <div class="col-lg">
                                <div
                                    ...
                                    <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                            Money</button></a><br>
                                    <h6>Click for sending money from your account.</h6>
                                </div>
                            </div>
                            <div class="col-lg">
                                <div
                                    ...
                                    <a href="check_blc.php"><button type="button" class="btn btn-outline-light mybtn">Check
                                            Balance</button></a><br>
                                    <h6>Click for checking the remaining balance in your account.</h6>
                                </div>
                            </div>
                        </div>
                    </div>
